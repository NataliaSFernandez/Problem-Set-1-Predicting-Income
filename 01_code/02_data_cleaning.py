...
plt.tight_layout()
plt.savefig("02_output/figures/outliers_income_boxplot.png", dpi=300, bbox_inches='tight')
plt.close()
...
print("\nPRÓXIMOS PASOS:")
print("  1. Revisar outputs generados")
print("  2. Ejecutar análisis estadístico")
print("  3. Ejecutar regresiones")
