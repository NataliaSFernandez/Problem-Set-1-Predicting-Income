...
# Guardar en LaTeX
with open("02_output/tables/descriptive_stats_general.tex", "w") as f:
...
print("\nGuardado: 02_output/tables/descriptive_stats_general.tex")
...
with open("02_output/tables/descriptive_stats_gender.tex", "w") as f:
    f.write("\\begin{table}[h]\n")
    f.write("\\centering\n")
...
print("\nGuardado: 02_output/tables/descriptive_stats_gender.tex")
...
plt.tight_layout()
plt.savefig("02_output/figures/income_distribution_gender.png", dpi=300, bbox_inches='tight')
plt.close()
print("  Guardado: 02_output/figures/income_distribution_gender.png")
...
plt.tight_layout()
plt.savefig("02_output/figures/age_distribution.png", dpi=300, bbox_inches='tight')
plt.close()
print("  Guardado: 02_output/figures/age_distribution.png")
...
plt.tight_layout()
plt.savefig("02_output/figures/hours_distribution_gender.png", dpi=300, bbox_inches='tight')
plt.close()
print("  Guardado: 02_output/figures/hours_distribution_gender.png")
...
print("\nARCHIVOS GENERADOS:")
print("\nTablas:")
print("  1. 02_output/tables/descriptive_stats_general.tex")
print("  2. 02_output/tables/descriptive_stats_gender.tex")
print("\nGráficos:")
print("  1. 02_output/figures/income_distribution_gender.png")
print("  2. 02_output/figures/age_distribution.png")
print("  3. 02_output/figures/hours_distribution_gender.png")
